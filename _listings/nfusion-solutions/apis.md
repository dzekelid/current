...
- name: nFusion Solutions Market Data API v1 - Get latest Summary for requested currency
  ...
  - type: x-postman-collection
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/current/master/_listings/nfusion-solutions/apivversioncurrenciessummary-get-postman.md
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/current/master/_listings/nfusion-solutions/apivversioncurrenciessummary-get-openapi.md
- name: nFusion Solutions Market Data API v1 - Get latest Spot Summary for requested
  ...
  properties:
  - type: x-postman-collection
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/current/master/_listings/nfusion-solutions/apivversionmetalsspotsummary-get-postman.md
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/current/master/_listings/nfusion-solutions/apivversionmetalsspotsummary-get-openapi.md
x-common:
- type: x-blog-rss
