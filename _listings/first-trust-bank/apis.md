...
created: "2018-06-25"
modified: "2018-06-25"
url: https://raw.githubusercontent.com/streamdata-gallery-topics/current/master/_listings/first-trust-bank/apis.md
...
- name: First Trust Bank (Open Banking) Get Current Personal Accounts
  ...
  - type: x-postman-collection
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/current/master/_listings/first-trust-bank/personalcurrentaccounts-get-postman.md
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/current/master/_listings/first-trust-bank/personalcurrentaccounts-get-openapi.md
- name: First Trust Bank (Open Banking) Get Current Business Accounts
  ...
  properties:
  - type: x-postman-collection
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/current/master/_listings/first-trust-bank/businesscurrentaccounts-get-postman.md
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/current/master/_listings/first-trust-bank/businesscurrentaccounts-get-openapi.md
- name: First Trust Bank (Open Banking)
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/current/master/_listings/first-trust-bank/openapi.md
x-common:
- type: x-developer
